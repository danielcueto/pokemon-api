...
insert into trainer (name, second_name, age, region, badges) values
...
insert into pokemon (name, level, type_id, trainer_id, attack, defense, speed, is_legendary) values
